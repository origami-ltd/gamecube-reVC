...
#if defined(__SWITCH__) || defined(PSP2) || defined(GTA_OGC)
	#define GTA_HANDHELD
#endif
...
#ifdef GTA_OGC
// Console loads come off SD/disc and are slow, so the player needs feedback.
...
// Streaming
#if !defined(_WIN32) && !defined(__SWITCH__) && !defined(GTA_OGC)
